      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between py-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="w-16 h-16 bg-gray-700 rounded-full flex items-center justify-center shrink-0 border-2 border-gray-600">
              <span className="text-white font-bold text-2xl">MT</span>
            </div>
            
            {/* Logo Text */}
            <div className="flex flex-col relative">
              <span className="text-gray-400 text-xs absolute -top-4 left-0">SINCE 2020</span>
              <h1 className="text-3xl font-serif text-white font-bold leading-tight">Mirha Textile</h1>
              <p className="text-gray-400 text-sm">BY Talha Saleem</p>
            </div>
          </div>
